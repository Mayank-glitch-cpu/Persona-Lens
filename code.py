...
# Load the dataset
file_path = 'final_combined.csv'  # Replace with the actual path to your dataset
...
required_columns = [
    'username', 'name', 'bio', 'profile_links', 'public_repos', 'total_stars', 'total_forks',
...
print(data['popularity_score'])
# Optional: Round to 2 decimal places
# data['popularity_score'] = data['popularity_score'].round(2)
data['popularity_score'].head
...
print("Columns in the dataset with extracted features:", data.columns.tolist()) 
